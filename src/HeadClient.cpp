...
bool bDrawPoses = true;
bool bDrawReport = true;

//--------------------------------------------------------------
void HeadClient::setup(){
...
//--------------------------------------------------------------
void HeadClient::setupEstimator() {
    // Number of trees
    g_ntrees = 10;
    //maximum distance form the sensor - used to segment the person
    g_max_z = 2000;
    ...
    g_treepath = "/Users/tom/devel/OpenFrameworks-0.8.1/apps/tom/head_estimator_exaple/bin/data/trees/tree";
...
//--------------------------------------------------------------
void HeadClient::drawPointCloud() {
	ofMesh mesh;
...
//--------------------------------------------------------------
void HeadClient::keyPressed(int key){
    switch (key) {
...
//--------------------------------------------------------------
void HeadClient::keyReleased(int key){
    
}

//--------------------------------------------------------------
void HeadClient::mouseMoved(int x, int y ){
    
}

//--------------------------------------------------------------
void HeadClient::mouseDragged(int x, int y, int button){
    
}

//--------------------------------------------------------------
void HeadClient::mousePressed(int x, int y, int button){
    
}

//--------------------------------------------------------------
void HeadClient::mouseReleased(int x, int y, int button){
    
}

//--------------------------------------------------------------
void HeadClient::windowResized(int w, int h){
    
}

//--------------------------------------------------------------
void HeadClient::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void HeadClient::dragEvent(ofDragInfo dragInfo){
